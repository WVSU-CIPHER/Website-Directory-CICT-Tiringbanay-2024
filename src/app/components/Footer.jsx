...
export default function Footer() {
  return (
    <footer className="w-full h-full md:px-24 px-5 py-12 text-white rounded-md bg-black/50 backdrop-blur-md flex flex-col">
      <div className=" w-full h-full gap-6 md:gap-8 grid grid-cols-1 md:grid-cols-2 mx-auto">
        {/* Logo image */}
        <div className="flex gap-4 items-center mx-auto">
          ...
          <div className="flex flex-col gap-0">
            <h1
              className={`${chopsic.className} text-base md:text-lg tracking-[4px] md:tracking-[5px]`}
            >
              tiringbanay 2024
            </h1>
        ...
        <div className="flex w-full mx-auto">
          <div className="flex gap-3 px-2  border-l-4 border-l-[#7AD7CA] mx-auto">
            ...
            <div className="flex flex-col">
              <h1
                className={`${chopsic.className} uppercase text-xs md:text-sm tracking-[3px]`}
              >
                ui/ux
              </h1>
              {/* Names */}
              <div className="flex flex-col text-sm md:text-base">
                <Link href="https://github.com/Reiebenezer">
                  <span
                    className={`${poppins.className} font-md  text-xs  hover:text-[#7AD7CA] duration-100`}
                  >
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col gap-1 text-sm md:text-base">
                <Link href="https://github.com/tqcss">
                  <span
                    className={`${poppins.className} font-md  text-xs text-[14px] hover:text-[#7AD7CA] duration-100`}
                  >
                    Ken Meiro Villareal
                  </span>
                </Link>
