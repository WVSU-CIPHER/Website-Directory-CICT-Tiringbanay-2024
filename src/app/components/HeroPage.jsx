...
export default function HeroPage() {
  return (
    <>
      ...
      <div className="relative">
        <div className="mt-[180px] sm:mt-52 sm:ml-16 ml-4 flex flex-col gap-4">
          ...
          <Image className="mx-auto sm:mx-0"
            ...
            height={72}
          />
          <div className={`uppercase text-[14px]  sm:mt-4 mx-auto sm:mx-0 font-medium tracking-[4.48px] leading-[21px] text-white ${poppins.className}`}>
            A shift in reality
          </div>
        ...
        <div className={`${poppins.className} mt-[50px] ml-16 flex flex-row gap-8 sm:justify-start`}>
          <Link href="/groupings">
          ...
          <div
            ...
            onClick={() => document.getElementById('rationale').scrollIntoView({ behavior: 'smooth' })}
          >
            learn more
          </div>
      ...
      <div id="rationale" className="flex flex-col w-full sm:max-w-[1440px] mt-[240px] py-8 px-4 sm:px-16 mx-auto rounded-none sm:rounded-2xl backdrop-blur-md  bg-[#010004d8] sm:bg-[#01000499] z-1 relative">
      ...
      <div className="flex flex-col w-full sm:max-w-[1440px] mb-10 mt-0 py-8 px-16 sm:mt-16 mx-auto rounded-none sm:rounded-2xl backdrop-blur-md bg-[#010004d8] sm:bg-[#01000499] z-1 relative">

        <div className="text-white flex flex-col px-8">
          <div className="font-chopsic text-center text-[24px] uppercase pb-9 tracking-widest">Guest Speakers</div>
        </div>

        <div className="grid grid-flow-row sm:grid-flow-col gap-8 px-4 sm:px-12 justify-items-center">
          <div className="flex flex-col items-center">
            ...
            <div className="text-[14px] font-medium text-center pt-4">
        ...
        <div className="flex justify-center mt-12">
          <div className="flex flex-col items-center">
            ...
            <div className="uppercase font-chopsic pt-4 text-[18px] tracking-[0.72px] px-9 text-center">firstname lastname</div>
            <div className={`${poppins.className} pt-2 uppercase text-[14px] font-medium text-center`}>title</div>
            <div className="text-[14px] font-medium text-center pt-4">Lorem ipsum dolor sit amet,
              <br />educslierwjogn fmwoimdqocwi
            </div>
